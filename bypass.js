...
process.on("unhandledRejection", errorHandler);
 ...
 function getRandomDate(start = new Date(2025, 10, 15), end = new Date()) {
...
const tips1 =[
 ...
 "dont trying resell my script!! @ch4ntzy",
 "My channel: https://t.me/ch4ntzy"
];
const platformd = [
 "Windows",
 "Linux",
...
const RESTART_DELAY = 1000;
 ...
 if (cluster.isMaster) {
    console.clear()
    console.log(`HTTP-DDoS bypass by: @ch4n_tzy (ch4ntzy) 12/4/2023`.rainbow)
    console.log(`--------------------------------------------`.gray)
